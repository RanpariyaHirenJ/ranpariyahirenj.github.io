...
$('.mobil-icon-toggle').click(function(){
    ...
    {
        $('.header-lower-left').addClass('menubaropen');
		$('.header-lower-left').addClass('fadeInRight');
		$('.header-lower-left').removeClass('fadeOutRight');
    }
    else
    {
		setTimeout(function(){ 
		$('.header-lower-left').removeClass('menubaropen');
		}, 1000);
  
		$('.header-lower-left').removeClass('fadeInRight');
		$('.header-lower-left').addClass('fadeOutRight');
    }
});
...
$('.topband span.search').click(function () {
	$('.searchbox').toggleClass('active');
});
$('ul.searchboxlist li.search a.search').click(function () {
	$('.searchbox').css('display', 'none');
	$("p.searchresult").css('display', 'block');
});

$('p.searchresult input.reset').click(function () {
	$('p.searchresult').css('display', 'none');
	$(".searchbox.active").css('display', 'inline-block');
});
