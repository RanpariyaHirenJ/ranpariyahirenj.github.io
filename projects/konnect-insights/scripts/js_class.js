		...
		{				
			case "text":
				if($(this).val() == "")
				{
					...
					$('.inputType').css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
					$(".input-type-select").css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
					$(this).val('');
					$(this).next('.error-msg').html(""+title+" Cannot be blank !");
					return_state = false;													
				}
				else
				{
					//$(this).css("border-bottom","1px solid green");
					//$('.inputType').css("background-image","linear-gradient(green, green), linear-gradient(green, green)");
			...
			case "password":
				...
				else if($(this).val().length < 6)
				{
					...
					$(this).css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
					$(this).val('');		
					$(this).next('.error-msg').html(""+title+" should be min 6 char!");			
			...
			case "email":
				...
				else if($(this).val().indexOf('@') == -1 || $(this).val().indexOf('.') == -1)
				{
					...
					$(this).css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
					$(this).val('');
					$(this).next('.error-msg').html(""+title+" is not valid email address!");
			...
			else if(isNaN($(this).val()))
			{
				...
				$(this).css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
				$(this).val('');
				$(this).next('.error-msg').html(""+title+" should be numeric !");
			...
			else if($(this).val().length < 10)
			{
				...
				$(this).css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
				$(this).val('');
				$(this).next('.error-msg').html(""+title+" must be 10 digits !");
			...
			case "number":
				...
				else if(isNaN($(this).val()))
				{
					...
					$(this).css("background-image","linear-gradient(red, red), linear-gradient(red, red)");
					$(this).val('');
					$(this).next('.error-msg').html(""+title+" is not valid number!");
