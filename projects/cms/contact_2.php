<?php 
	...
	if(isset($_POST["username"]))
	{
		...
		else
		{
			...
			$body 		= "Name: $username<br/><br/>Email: $useremail<br/><br/>Mobile: $usermobile<br/><br/>Product: $product<br/><br/>Address: $useraddress<br/><br/>Comments: $usercomments";
			$to 		= "kalpesh@intermind.in";
			//$to 		= "contact@cms.com";	
    ...
    <div class="row">
      ...
      <div class="col-3 level2" data-aos="fade-up">
        <div class="card-name">
          ...
          <a href="mailto:a.chandrasekharan@cms.com" class="email-icon link-style">ra.chandrasekharan@cms.com</a>
        </div>
      </div>
      <div class="col-3 level2" data-aos="fade-up">
        <div class="card-name">
