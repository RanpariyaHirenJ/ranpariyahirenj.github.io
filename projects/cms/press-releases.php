...
<meta charset="UTF-8">
<title>Press Releases | CMS Info Systems</title>
...
<section id="cash-management-solution" class="layout-2" style="background: url(images/press-releases-banner.jpg) no-repeat 0px 0px fixed;background-size: cover;">
    <div data-aos="fade-up" class="align-v-center banner-height overlay-bg">
