...
(function($){
	...
	$.movingBoxes = function(el, options){
		...
		base.setSizes = function(flag){
			...
			base.curWidth = (o.panelWidth) ? (o.panelWidth <=1 ? o.panelWidth * base.width : o.panelWidth) : base.pWidth;
...
$(function(){
	...
	$('#slider-two').movingBoxes({
		...
		// width and panelWidth options removed in v2.2.2, but still backwards compatible
		 //width        : 1008,    // overall width of movingBoxes (not including navigation arrows)
