...
if(isset($_POST['submit']))
{
    ...
    $mail->Username = "hirenranpariyaofficial@gmail.com"; // Your mail
    $mail->Password = 'hiren@official@7'; // Your password mail
    $mail->Port = 587; //specify SMTP Port
    $mail->SMTPSecure = 'tls';                               
    $mail->setFrom($_POST['email'],$_POST['name']);
    $mail->addAddress('hirenranpariyaofficial@gmail.com');
