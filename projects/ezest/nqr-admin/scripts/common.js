...
$(function () {
    ...
    $(".edit_client").click(function () {
        $('.client_name').parent().find('label').addClass('active')
        $('.client_name').val($(this).parent().find('.tag1').html());
    })


    $(".edit_client_btn").click(function () {
        alertval("Alert", "Are you sure you want to edit this record ?")
    })

    $(".edit_rolls").click(function () {
        $('.roll_name').parent().find('label').addClass('active')
        $('.roll_name').val($(this).parent().parent().find('.tag1').html());
    })

    $(".edit_roll_btn").click(function () {
        alertval("Alert", "Are you sure you want to edit this record ?")
    })

    $(".add_roll_btn").click(function () {
        alertval("Alert", "Are you sure you want to save this record ?")
    })
    ...
    $(".edit_quest_typ").click(function () {
        $('.quest_type_name').parent().find('label').addClass('active')
        $('.quest_type_name').val($(this).parent().find('.tag1').html());
    })

    $(".edit_quest_typ_btn").click(function () {
        alertval("Alert", "Are you sure you want to edit this record ?")
    })

    $(".add_quest_typ_btn").click(function () {
        alertval("Alert", "Are you sure you want to save this record ?")
    })

    $(".edit_category").click(function () {
        $('.category_name').parent().find('label').addClass('active')
        $('.category_name').val($(this).parent().parent().find('.tag1').html());
    })
    ...
    $(".save_quest_btn").click(function () {
        alertval("Alert", "Are you sure you want to save this record ?")
    })

    $(".edit_view_quest").click(function () {
        $('.view_quest_name').parent().find('label').addClass('active')
        $('.view_quest_name').val($(this).parent().parent().find('.tag1').html());
    })

    $(".edit_email_maintenance").click(function () {
        $('.email_maintenance_name').parent().find('label').addClass('active')
        $('.email_maintenance_name').val($(this).parent().find('.tag1').html());
    })

    $(".add_email_maintenance_btn").click(function () {
        alertval("Alert", "Are you sure you want to edit this record ?")
    })

    $(".edit_manage_temp").click(function () {
        $('.manage_temp').parent().find('label').addClass('active')
        $('.manage_temp').val($(this).parent().find('.tag1 input').val());
    })

    $(".add_manage_temp_btn").click(function () {
        alertval("Alert", "Are you sure you want to edit this record ?")
    })
