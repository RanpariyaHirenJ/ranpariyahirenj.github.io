...
if(isset($_REQUEST['action']))
{
	if($_REQUEST['action'] == "SUBMIT")
	{
		...
		else
		{
    		...
    		curl_setopt($ch, CURLOPT_POSTFIELDS, "user_id=34&project_name=Babu Tea & Coffee&enquiry_type=Contact page&enquiry_details=$message&datetime=$datetime&cust_ip=$myip");
