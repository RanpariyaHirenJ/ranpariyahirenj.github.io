...
if(isset($_POST['leadpage']) && $_POST['leadpage']!="questionnaire" )
{
...
if(isset($_POST['leadpage']) && $_POST['leadpage']=="questionnaire"){
  ...
  $array = json_decode($_POST['myData'],true);


  $body = '
             <table width="600" border="0" cellspacing="5" align="center" style="border:#999 solid 5px;font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#333;padding:10px;">
              <tr><td align="left" colspan="3" ><img src="http://dznquotient.com/images/logo.png" style="margin-top:0px;padding-left:0px;"></td></tr>
              <tr><td align="center" colspan="3"><h2>Questionnaire Page</h2></td></tr>
              <tr>
                <td colspan="3">Dear Admin,<br><br/>
                  You have a new user following details from questionnaire page as below.</td>
              </tr>
               <tr>
                <td  align="left">&nbsp;</td>
             ...
             $body .='<tr>
                <td  align="left"><span style="font-weight:bold; width:300px">'.$key.'</span></td>
            ...
            $body .='   <tr>
                <td  align="left"><span style="margin-left: 10px;width: 300px;font-size: 13px;"><b>Ques</b> : '.$value1['ques'].'</span></td>
               
              </tr>
               <tr>
                <td  align="left"><span style="margin-left: 10px;width: 300px;font-size: 13px;"><b>Ans</b>&nbsp;&nbsp;&nbsp;: '.$value1['ans'].'</span></td>
               
              </tr>';
            }
            }
            $body .='<tr>
                <td  align="left" style="border-bottom: 1px solid #b0afaf;">&nbsp;</td>
             ...
             $body .='<tr>
              ...
              <tr>
                <td colspan="3">From,<br/>dznquotient.com
                </td>
              </tr>
            </table>
            ';

          $subject  = "You have a new user following details from questionnaire page";

          $mail_data['action'] = 'mail_send';
          $mail_data['to'] = 'pankaj@dznquotient.com';
          $mail_data['from'] = 'info@intermind.in';
          $mail_data['project_name'] = 'Dznquotient Questionnaire';
          $mail_data['subject'] = $subject;
          $mail_data['body'] = $body;
