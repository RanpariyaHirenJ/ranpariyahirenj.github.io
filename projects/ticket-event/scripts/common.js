...
/*****Events Dropdown******/
$(function(){
$('.selectMenuEvents h3').mouseover(function(){
$(this).next('.selectMenuListEvents').slideDown();
...
$('.selectMenuListEvents').click(function(){
...
$(document).ready(function(){
    $(".tkt-type").click(function(){
	$('.tkt-type').removeClass('active-number');		
        $(this).addClass("active-number");
    });
});
...
$(function () {
	$('.pdf input[type=file]').change(function(){
		var fval=$(this).val();
		var filterValue = fval.replace("C:\\fakepath\\", "");
		$(this).parents('.pdf').find('span').html(filterValue);
	})
});

$(function(){

$(".upload-ticket").mouseover(function(){
$(this).prev().addClass("orange-bg");
});

$(".upload-ticket").mouseout(function(){
$(this).prev().removeClass("orange-bg");
});
});
...
$('#heart').attr('src', 'images/heart-orange.png');
});
...
function changeImg() {
    ...
    if (image.src.match("orange")) {
        ...
        image.src = "images/heart-orange.png";
    }
}
...
$(".grid-5").mouseover(function(){
$(this).parent().addClass("bg-color-grey");
});

$(".grid-5").mouseout(function(){
$(this).parent().removeClass("bg-color-grey");
});
});
...
$(function(){
$("#photo-copy-tkt-list li:nth-child(odd)").mouseover(function(){
$(this).addClass("bg-color-grey");
});

$("#photo-copy-tkt-list li:nth-child(odd)").mouseout(function(){
...
$(".grid-6 img").mouseover(function(){
$(this).attr('src', 'images/delete-red.png');
});

$(".grid-6 img").mouseout(function(){
...
$(".enter-face-value .form input").click(function(){
	 if(this.checked) {
    $(this).parent().addClass("bg-color-grey");
  }
   else{
