...
function gcaptecha($recaptcha){
	...
	$data = array(
		'secret' => '6Lctz5IUAAAAADj51alTXCf7GhjEkyZ7gzlRTpp1',
		'response' => $recaptcha
	);
	$options = array(
		'http' => array (
...
{				
	...
	$headers .= 'From: '.$fromname[0].' <'.$fromname[1].'>'."\r\n";
	$headers .= "BCC: info@intermind.in, hiren@intermind.in, ritesh.kalptech@gmail.com\r\n";						
