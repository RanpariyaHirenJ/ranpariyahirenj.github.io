...
$(document).ready(function() {
	$('#aloevera_check').click(function(){
		if ($('#aloevera_check').is(':checked')) {
			$('#aloevera_qty').val('1');
			$('#aloevera_div').show();
		}
		else {
	...
	$('#karela_check').click(function(){
		if ($('#karela_check').is(':checked')) {
			$('#karela_qty').val('1');
			$('#karela_div').show();
		}
		else {
	...
	$('#jamun_check').click(function(){
		if ($('#jamun_check').is(':checked')) {
			$('#jamun_qty').val('1');
			$('#jamun_div').show();
		}
		else {
...
function checkbox_form(){
	...
	if ($('#aloevera_check').is(':checked')) {
		if($('#aloevera_qty').val() == ""){
			$('#aloevera_qty').css("border","1px solid red");
			$('#aloevera_qty').val('');
			return false;
		}
		else{
			aloevera_qty = $('#aloevera_qty').val();
			product_name = product_name.concat('Aloe Vera Juice,');
			product_qnty = product_qnty.concat(aloevera_qty+','); 
		}
	}
	if ($('#karela_check').is(':checked')) {
		if($('#karela_qty').val() == ""){
			$('#karela_qty').css("border","1px solid red");
			$('#karela_qty').val('');
			return false;
		}
		else{
			karela_qty = $('#karela_qty').val();
			product_name = product_name.concat(' Karela Juice,');
			product_qnty = product_qnty.concat(karela_qty+',');  
		}
	}
	if($('#jamun_check').is(':checked')){
		if($('#jamun_qty').val() == ""){
			$('#jamun_qty').css("border","1px solid red");
			$('#jamun_qty').val('');
			return false;
		}
		else{
			jamun_qty = $('#jamun_qty').val();
			product_name = product_name.concat(' Jamun Juice,');
			product_qnty = product_qnty.concat(jamun_qty+','); 
		}
	}
	product_name = product_name.slice(0, -1);
	product_qnty = product_qnty.slice(0, -1);
	$('#product_name').val(product_name);
	$('#product_qnty').val(product_qnty);
	$('.closeBtn').click();setTimeout(function() {overlayBox('buy-now');}, 1100);
	
}

function checkbox_buy_form(){
	var product_name = "";
	var product_qnty = "";
	if ($('#aloevera_check').is(':checked')) {
		if($('#aloevera_qty').val() == ""){
	...
	$('#product_name').val(product_name);
	$('#product_qnty').val(product_qnty);
	$('.closeBtn').click();setTimeout(function() {overlayBox('buynow');}, 1100);
