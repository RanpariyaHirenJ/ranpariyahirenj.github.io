...
(function() {
  ...
  function toggleHandler(toggle) {
	...
	$('.selectMenuCnt h3').click(function(){
		...
		$(this).css({'border-radius':'0px','border':'3px solid #f0f0f0','background-color':'#fff','color':'#000'});
		$('.selectMenuList').css({'background-color':'#fff','color':'#000'});
	})
	$('.selectMenuList ul li').click(function(){
		var menu = $(this).html()
		var menuid=$(this).attr('id');
		$(this).parents('.selectMenuList').slideUp();
		$(this).parents('.selectMenuList').css({'background-color':'#fff','color':'#000'})
		$(this).parents('.selectMenuList').prev('h3').html(menu);
		$(this).parents('.selectMenuList').prev('h3').attr('id',menu);
		$(this).parents('.selectMenuList').prev('h3').css({'border-radius':'5px','border':'3px solid #f0f0f0','background-color':'#fff','color':'#000'})
	})
...
$('.selectMenuList').prev('h3').css({'border-radius':'50px','border':'3px solid #f0f0f0','background-color':'#fff'})
$('.selectMenuList').css({'background-color':'#fff'})
}
