...
if($(window).width() > 1024){
    if ($(this).scrollTop() > 200) {
     ...
     // $('.fixed-header .container').css("max-width", "100%"); 
	  $(".autohanger-contact-details").addClass("fixed-header-autohanger");
    } 
	else 
	{
	  $(".header").removeClass("fixed-header");
     // $('.header .container').css("max-width", "1200px");
	  $(".autohanger-contact-details").removeClass("fixed-header-autohanger");
  $(".logo").css("opacity", 1 - $(window).scrollTop() / 180);
    }
}
  }); 
