...
if(isset($_REQUEST['action']))
{
	if($_REQUEST['action'] == "Submit")
	{
		...
		if($cptcha != 1)
		{
    		...
    		echo "<script>window.location.href='".$url_name[0]."?error'</script>";
		}
		else
		{
    		...
    		$to = "malhir@malhir.net, sriram.krishnan@mispl.co";
    		...
    		curl_close ($ch);
    		echo "<script>window.location.href='".$url_name[0]."?enquiry=succes'</script>";
		}
	}
}
die();
