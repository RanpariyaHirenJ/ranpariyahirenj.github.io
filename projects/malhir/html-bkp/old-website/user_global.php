...
{	
	...
	{
		redirect("index.html?error=Invalid login, please login first to access your account.");
		die();
	}
}
...
function error_found($error_level,$error_message,$error_file,$error_line){
	...
	//*************Send Mail****************
	//send_email("om.maurya0207@gmail.com","errors@thewritingjunction.com,errors@TWJ",$subject,$error);	
