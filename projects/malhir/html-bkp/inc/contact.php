...
if(isset($_REQUEST['action']))
{
	if($_REQUEST['action'] == "Submit")
	{
		...
		else
		{
    		...
    		$headers .= 'From: Mihir <info@malhir.net>'."\r\n";
    		...
    		curl_setopt($ch, CURLOPT_POSTFIELDS, "user_id=19&project_name=Mihir&enquiry_type=Contact page&enquiry_details=$message&datetime=$datetime&cust_ip=$myip");
