...
$base_url 	= "http://staging.intermind.in/ashutoshshinde/html/";
//$base_url 	= "http://intermindserver/cms/php/";
...
$username 	= "root";
$password 	= "";
$database	= "intermin_cms";*/

$host		= "localhost";
$username 	= "cmscool4_cmsuat";
$password 	= "cms1nf0@UAT";
$database	= "cmscool4_cmsuat";
...
function gcaptecha($recaptcha){
	...
	$data = array(
		'secret' => '6Ldf5KkeAAAAANxFvOhDO0woiQRxqCnc7EyAv5cD',
		'response' => $recaptcha
	);
	$options = array(
		'http' => array (
...
function bmi($val,$gender){
	if($gender == "All"){
		if($val < 18.5){
				$stages = "Underweight";
				$img = "over-all-blue.png";
			}elseif($val >= 18.5 && $val <= 24.9){
				$stages = "Healthy";
				$img = "over-all-green.png";
			}elseif($val >= 24.91 && $val <= 29.9){
				$stages = "Overweight";
				$img = "over-all-orange.png";
			}else{
				$stages = "Obese";
				$img = "over-all-red.png";
			}
	}elseif($gender == "Male"){
		
		if($val < 18.5){
				$stages = "Underweight";
				$img = "round-man-icon-blue.png";
			}elseif($val >= 18.5 && $val <= 24.9){
				$stages = "Healthy";
				$img = "round-man-icon-green.png";
			}elseif($val >= 24.91 && $val <= 29.9){
				$stages = "Overweight";
				$img = "round-man-icon-orange.png";
			}else{
				$stages = "Obese";
				$img = "round-man-icon-red.png";
			}				
	}elseif($gender == "Female"){
		if($val < 18.5){
				$stages = "Underweight";
				$img = "round-female-icon-blue.png";
			}elseif($val >= 18.5 && $val <= 24.9){
				$stages = "Healthy";
				$img = "round-female-icon-green.png";
			}elseif($val >= 24.91 && $val <= 29.9){
				$stages = "Overweight";
				$img = "round-female-icon-orange.png";
			}else{
				$stages = "Obese";
				$img = "round-female-icon-red.png";
			}					
	}else{
	echo "parameter missing";
	}
return array($stages, $img);
}
