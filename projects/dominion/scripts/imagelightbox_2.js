    ...
    $.fn.imageLightbox = function (opts) {
        var options = $.extend({
            ...
            previousTargetDefault: function () {
                ...
                $('#caption').remove();
                $('<div id="caption" style="color:#fff;z-index:9999999999;position:fixed;bottom:33px;background: rgba(121, 109, 109, 0.5);width: 100%;text-align: center;padding: 5px 0;">' + $(target).attr("data-text") + '</div>').appendTo('body');
