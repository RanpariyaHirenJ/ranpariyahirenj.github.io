! function(t) {
    ...
    const barbaJs = {
        ...
        initBarba() {
            ...
            }), barba_js__WEBPACK_IMPORTED_MODULE_0___default.a.Dispatcher.on("linkClicked", function(el) {
                window.lastElementClicked = el;
                console.log(el)
        ...
        FadeTransition: barba_js__WEBPACK_IMPORTED_MODULE_0___default.a.BaseTransition.extend({
            ...
            fadeIn: function() {
                setTimeout(() => {
                    window.scrollTo(0, 0)
                    window.lastHashInit = (el) => {
                        if(el){
                            var lastHash = el.getAttribute("data-hash");
                            if(lastHash || lastHash!=""){
                                var scrollTopThis = $("#"+lastHash).offset().top
                                window.scrollTo(0, scrollTopThis)
                            }
                            else{
                                window.scrollTo(0, 0)
                            }
                    ...
                    $(".grid").addClass("off"), $(".cursor-follower").removeClass("loading"), this.done(), window.lastHashInit(window.lastElementClicked);
                }, 2e3)
            }
        })
    };
    ...
    const Jt = {
        slider: null,
        initLoad() {
            this.initCarousel(), this.initCarousel2(), this.initPartners(),this.journeyCarousel()
        },
        initCarousel() {
            const t = $(".carousel");
        ...
        initCarousel2() {
            ...
            if (carousel2.length < 1) return !1;
            carousel2.find(".carousel__title a").on("click", function(carousel2) {
                return !1
            }), carousel2.find(".carousel__item").on("mousedown", function(carousel2) {
                $(this).data("p0", {
                    x: carousel2.pageX,
                    y: carousel2.pageY
                })
            }).on("mouseup", function(carousel2) {
                const carousel2_e = $(this).data("p0"),
                carousel2_i = carousel2.pageX,
                carousel2_n = carousel2.pageY;
                Math.sqrt(Math.pow(i - carousel2_e.x, 2) + Math.pow(carousel2_n - carousel2_e.y, 2)) < 4 && "undefined" !== $(this).find("a").attr("href") && void 0 !== E.a && r.a.Pjax.goTo($(this).find("a").attr("href"))
            }), Jt.slider = Zt({
                container: ".carousel2",
                items: 1,
                edgePadding: 30,
    ...
    const ie = {
        ...
        initMap: () => {
            ...
            let i = new google.maps.Marker({
                ...
                map: e,
                url: "https://www.google.it/maps/place/Kathuria+Rollmill+Private+Limited/@28.6586696,77.4211333,14z/data=!3m1!4b1!4m5!3m4!1s0x390cf1934e30505b:0xd8c9e4b4fb18a443!8m2!3d28.6586331!4d77.4386429"
            });
