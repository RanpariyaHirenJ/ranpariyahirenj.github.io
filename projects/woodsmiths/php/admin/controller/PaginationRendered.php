...
class PaginationRendered{
    ...
    protected $queryStringSegment = 0;
    ...
    function createLinks(){ 
        ...
        $this->currentPage = $this->queryStringSegment;
        ...
        //    $output .= '<a href="javascript:void(0)">'.$info.'</a>';
        // }
        ...
        //     $firstPageURL = trim($this->baseURL,'/');
