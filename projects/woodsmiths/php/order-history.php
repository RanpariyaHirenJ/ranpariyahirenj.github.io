    ...
    <div class="page-container container">
     <div class="table-responsive">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <?php   
             ...
             ?>
              <tr>
              <td class="text-right">#<?php  echo $value['order_no'] ?></td>
      ...
      <?php   }else{ ?>
        ...
        <div style="width: 100%;font-size: 20px;font-weight: 600"><center>It seems like you haven't placed any order yet. <a href="" style="color:red">Click Here</a> To start shopping now!</center> </div> <br>
      <?php } ?>
      </div>
