...
<div style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#000000">
  ...
  <p>Congratulations! We have a new <?php echo $data['order']['order_details']['order_type']?'Order':'Enquiry'; ?> from Woodsmiths.com.</p>
 
  <p><b>The customer details are as follows</b></p>
...
<p><span style="margin:px 20px 18px 20px;width:640px"><a href="<?php echo base_url.'admin/order-details/'.$data['order']['order_details']['order_id']; ?>">Click Here</a> to view the order details on the Admin Panel.</span></p><br>
