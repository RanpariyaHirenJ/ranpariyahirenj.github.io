 ...
 <?php
	...
	else
	{
	  ...
	  ?>
        <tr>
               <td width="33%" align="left">
                  <span style="margin-left:50px;"><strong><label>Customer Name :</label></strong>
                  <?php echo $result['client_name'];?></span>
               </td>
              ...
              <td width="33%" align="right">
                  <span style="margin-right:50px;"><strong><label>Email :</label></strong>
                  <?php echo $result['clent_email'];?></span>
              </td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="select-order">
        <tr>
           <td width="33%" align="left">
              <strong><span style="margin-left:50px;">Ordered On :</span></strong> <?php echo date_format(date_create($result['order_date']),'d/m/Y');?>
           </td>
           <td width="33%" align="right">
              <span style="margin-right:50px;"><strong>Delivery Date : </strong><?php echo date_format(date_create($result['delivery_date']),'d/m/Y');?></span>
                           ...
                           <table width="100%">
                            ...
                            $sql_property = "SELECT property_id,property_value_id FROM order_property op
							 ...
							 while($value_property = mysqli_fetch_array($result_property))
							 {
								...
								?>
                               <td width="33%"><strong><?php echo ucfirst($property['property_name']);?> :</strong> <?php echo ucfirst($property_value['property_value_name']); ?> </td>
