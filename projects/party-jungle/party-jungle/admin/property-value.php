...
<div class="wraper">
  <h1 class="pageName"><span style="text-transform:capitalize">Manage Values For <?php echo $value_item['property_name'] ?></span></h1>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="6" align="center" style="vertical-align:middle">
                    	<input name="action" type="button" value="Back To Property" onClick="location.assign('manage-property.php')" class="action-button" >
                		&nbsp;
                		<input name="action" type="button" value="Add Value" onClick="pop_up_box()" class="action-button">
                		&nbsp;
                		<input name="action" type="submit" value="Delete" class="action-button">                    
                    </td>
                  </tr>
                  <tr>
                    <td colspan="6" align="center" style="vertical-align:middle"><div class="pagerCnt"><?php echo($objpaging->display_paging()) ?></div></td>
                  </tr>   
                </table>
              </div>
