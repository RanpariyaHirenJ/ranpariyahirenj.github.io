	...
	switch($_REQUEST['action'])
	{
				...
				if(isset($_SESSION['order']))
				  {
						...
						{
							$sqlhelper1->adddata("order_id, item_id, our_cost, client_cost, product_note","$order_id, $val[0], '$val[1]', '$val[2]', '$val[3]'");
		...
		break;
  		...
  		case"delete":
			...
			{ 
				unset($_SESSION['order']);
				header('Location: calendar.php?error=Empty order list!!');
				die();
			}
  ...
  <div class="formCntr" id="library-history">
    ...
    <div style="padding:5px 20px; ">
		 <div class="fldCntr order-confirm" style="border:none !important;" align="center">
           <form action="order-confirmation.php?itemkey=<?php echo $itemkey ?>" method="post">
           ...
           <tr style="border-bottom:1px solid #000000;">
               <td width="20%"><label><strong><u><?php echo $item_value['item_name'] ?></u></strong></label><br><br>
                   <img src="../item-photos/<?php echo $item_value['item_photo'] ?>" width="100" height="100" />
               </td>
               <td width="80%">
               		<table>
                    	<tr>
                           <td>
                              <table width="100%">
                                 <tr>
                                    ...
                                    <input name="our_cost"  type="text" value="<?php echo $ourcost ?>"> 
                                    </td>
                                    <td width="30%"><label>Customers Cost</label>
                                    <input name="customer_cost"  type="text" value="<?php echo $customercost ?>"> 
                                    </td>
     ...
     <td>
      ...
      <div class="contents order-content"> 
          <table width="70%" border="0" cellpadding="0" align="center" cellspacing="0" class="order-product-list">
           <tbody><tr>
               <td width="20%" style="padding-top:10px !important;"><label><strong><u>Candy Bouquet</u></strong></label><br><br>
                 
                    <img src="../item-photos/0707201516002714.jpg" width="100" height="100">
               </td>
               <td width="80%">
                		<table width="90%">
                        <tbody><tr>
                        ...
                        <tr>
                          <td>
                              <table width="100%">
                                 <tbody><tr>
                                   <td width="50%"><strong>Flavors :</strong> Strawberry And Vanilla</td>
                                     <td width="50%"><strong>Wrapping :</strong> Plastic</td>
                                     </tr><tr>                                 </tr>
                            </tbody></table>
                           </td>
                       </tr>
            	...
            	<table width="95%">
                    <tbody><tr>
                       <td>
                          <table width="100%">
                              <tbody><tr>
                             <td width="20%"><strong>Unit Price</strong>:$0</td>
                             <td width="20%"><strong>Quantity</strong> : 1</td>
                             <td width="20%"><strong>Total Price</strong> :$0</td>
                              </tr>
                              <tr>
                              <td colspan="3">
                                	<div style="text-align:right; margin-top:15px;">
                                        <input type="button" value="Remove" onclick="location.assign('order-confirmation.php?action=delete&amp;item=0')">&nbsp;&nbsp;
                                        <input type="button" value="Edit" onclick="location.assign('order-confirmation.php?action=Modify&amp;item=0')">
                                    </div>
                                </td>
                            </tr>
                        </tbody></table>
    ...
    <?php
      ...
      <table width="70%" border="0" cellpadding="0" align="center" cellspacing="0" class="order-product-list">
           <tr>
               <td width="20%" style="padding-top:10px !important;"><label><strong><u><?php echo ucwords($result['item_name']); ?></u></strong></label><br><br>
                    ...
                    <img src="../item-photos/<?php echo $result['item_photo'];?>" width="100" height="100" />
               </td>
               <td width="80%" >
                		<table width="90%">
                        <tr>
                    ...
                    <tr>
                       <td>
                          <table width="100%">
                              ...
                              <tr>
                                <!--<td align="left" style="float:right;"><strong>Our Cost :&nbsp;</strong>  <?php echo "$".$val[1]; ?> &nbsp;&nbsp;|&nbsp;&nbsp; <strong>Customer Cost :&nbsp;</strong>  <?php echo "$".$val[2]; ?>
                                </td>-->
                                <td colspan="3">
                                	<div style="text-align:right; margin-top:15px;">
                                        <input type="button" value="Remove" onClick="location.assign('order-confirmation.php?action=delete&item=<?php echo $key ?>')">&nbsp;&nbsp;
                                        <input type="button" value="Edit" onClick="location.assign('order-confirmation.php?action=Modify&item=<?php echo $key ?>')">
                                    </div>
                                </td>
                                <?php /*?><td><input type="button" value="Remove" onClick="location.assign('order-confirmation.php?action=delete&item=<?php echo $key ?>')"></td>
                                 <td><input type="button" value="Edit" onClick="location.assign('order-confirmation.php?action=Modify&item=<?php echo $key ?>')"></td><?php */?>
      ...
      <div class="footer-buttons select-contents">
      		<div class="buttons btn-confirm fl">
                ...
                <input type="button" value="Back" onClick="location.assign('select-item-order.php')">
            </div>
