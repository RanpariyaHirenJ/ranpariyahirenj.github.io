<?php
	...
	if(isset($_REQUEST['action']))
	{
		$sql ="SELECT * FROM order_master WHERE order_id=".$_REQUEST['order_id'];
 			...
 			$username = ucwords(($value['client_fname']." ".$value['client_lname']));
	...
	/*	die($product_note);*/
	 ...
	 $data .= "<br><table  align=\"center\" width=\"95%\" style=\"border:1px solid #666666\"><tr><td>"; 
			$data .= "<table width=\"95%\" align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"10;\" style=\"font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#666;\">
					  <tr>
					  ...
					  <tr>
						...
						<td colspan=\"3\">".ucwords($username)."</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					  <td  colspan=\"4\" align=\"center\" style=\"background-color:#999;font-size:18px;color:#FFF\"><strong>Order Detail</strong></td>
					  </tr>
					  </table>";
		 ...
		 while($value = mysqli_fetch_array($result))
		 {
           ...
           <tr>
                            ...
                            <td width=\"70%\" style=\"border-top:1px solid #000000;\">
                                <table width=\"100%\" style=\"font-family:Arial, Helvetica, sans-serif;color:#000;font-size:14px\">
								  <tr>
								   ...
								   <td align=\"left\" style=\"float:left;\"  width=\"30%\"><strong>Our Cost&nbsp;:</strong>$".$value['our_cost']."</td>
								   
								   <td align=\"left\" style=\"float:left;\"  width=\"30%\"><strong>Total Price&nbsp;:</strong>$".$value['our_cost']*$value['quantity']."</td>
								  </tr>
                                </table>
                            </td>
                       </tr>
			...
			send_email($to,$from,$reply,"Order deatil from party jungle",$data);
	  ...
	  ?>
        <tr>
               <td width="33%" align="left">
                  ...
                  <span><?php echo ucfirst($result['client_fname'])." ".ucfirst($result['client_lname']);?></span>&nbsp;&nbsp;
               </td>
	...
	while($value = mysqli_fetch_array($result))
	{
 	 ...
 	 ?>
       <table width="70%" border="0" cellpadding="0" align="center" cellspacing="0" class="order-product-list">
           <tr>
               <td width="25%" style="padding:10px !important;" align="center">
               <table style="padding:0 !important" width="100%">
                    <tr>
                        <td style="background-color:<?php echo status_color($value['product_status']); ?>;color:#FFF;font-weight:bold; text-align:center"><?php echo ucfirst($value['item_name']);?></td>
                      </tr>
               </table>
             <br>
               ...
               <td width="75%" >
               		<table style="padding:0 !important" width="100%">
                    <tr>
                        <td style="background-color:<?php echo status_color($value['product_status']); ?>;color:#FFF;font-weight:bold; text-align:center"><?php echo product_status($value['product_status']); ?></td>
                      </tr>
                    	<tr>
                           <td>
                           <table width="100%">
                            ...
                            <td width="70%" style="border-top:1px solid #000000;">
                                <table width="100%">
                                      <tr>
                                           ...
                                           <td align="left" style="float:left;"  width="30%"><strong>Customer Cost&nbsp;:</strong><?php echo "$" .$value['client_cost']?></td>
     ...
     <script>
      ...
      <div class="footer-buttons select-contents">
            ...
            <a href="print_invoice.php?order_id=<?php echo $_REQUEST['order_id'] ?>" target="_new" style="    background: none repeat scroll 0 0 #424647;border: medium none;color: #FFFFFF;font-family: Arial,Helvetica,sans-serif;font-size: 14px;font-weight: bold;padding: 4px 8px;border-radius: 4px;" onClick="return confirm_delete()">Print</a>
                <input type="button" name="action" value="Email" onClick="email_invoice('<?php echo $_REQUEST['order_id'] ?>')">
                <input type="submit" value="Back to Calendar" onClick="window.location='calendar.php';">
            </div>
