...
<div class="wraper">
  <h1 class="pageName"><span style="color:#999">Manage Property For </span><?php echo $value_item['item_name'] ?></h1>
        ...
        <tr>
          <td align="center">
            <form method="post" name="delete_form" onSubmit="return confirm_delete()">
              ...
              <p class="sbtBtn">
              <input name="action" type="button" value="Back To Item" onClick="location.assign('manage-items.php')">
                &nbsp;
                <input name="action" type="button" value="Add Property" onClick="pop_up_box()">
                &nbsp;
