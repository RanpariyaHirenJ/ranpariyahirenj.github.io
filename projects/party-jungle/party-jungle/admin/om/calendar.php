...
if(isset($_REQUEST["action"]))
{
	...
	switch($_REQUEST["action"])
	{
		case "Save":
			...
			$_SESSION['client']['client_fname'] 	= $db_object->sanatize_string(ucfirst($_REQUEST["client_fname"]));
			$_SESSION['client']['client_lname'] 	= $db_object->sanatize_string($_REQUEST["client_lname"]);
			...
			redirect("select-item-order.php?error=Order has been created successfully");
			die();
		break;
         ...
         <form action="calendar.php" method="post" onSubmit="return form_validate_jquery('.formCntr')">
		  ...
		  <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvF1" style="border:1px solid #000000; padding:10px 5px;">
              ...
              <tr>
                    ...
                    <td width="30%" >
                    <input name="client_fname"  type="text" style="width:221px; margin-right:10px;" title="First Name" placeholder="First Name" value="" validation="text"> 
                    </td>
                    <td width="" >
                    <input name="client_lname"  type="text" style="width:221px" title="Last Name" placeholder="Last Name" value="" validation="text"> 
                    </td>
                </tr>
                <tr>
                ...
                <td colspan="3">
                	...
                	<!--<a href="select-item-order.php"><input name="action"  type="button" value="Save"></a-->
              ...
              <label>Month </label>
               <select class="left-select-M" name="month">
                    ...
                    <option value="12" <?php echo $db_object->return_compare($month,12,"selected=\"selected\"","") ?>>Dec</option>
                     ...
                     <label>Year </label>
                    <select class="left-select-M" name="year"><br>
                    <?php
                ...
                <option value="7" <?php echo $db_object->return_compare($product_status,7,"selected=\"selected\"","") ?>>Payment Received</option>
                    ...
                    <input name="action" type="button" value="Create A New Order" onClick="overlayBoxNorefresh('data-entry')">
               </strong>
