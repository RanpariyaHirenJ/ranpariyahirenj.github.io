    ...
    <div style=\"padding:5px 20px; \">
		 ...
		 while($value = mysqli_fetch_array($result))
		 {
			...
			<table width=\"100%\" border=\"0\" cellpadding=\"0\" align=\"center\" cellspacing=\"0\" class=\"order-list\">
			   ...
			   <label><strong><u>".ucfirst($value['client_fname'])." ".$value['client_lname']."</u></strong></label>
			   </td>
			   ...
			   <tr>
				   <td width=\"20%\" style=\"text-align:center; \"><br>
					   <img src=\"../item-photos/".get_thumbnail($value['item_photo'])."\" height=\"180\" width=\"180\"><label><strong><u>".ucfirst($value['item_name'])."</u></strong></label>
				   </td>
				   <td width=\"80%\" >
						   <table width=\"90%\">
						  ...
						  <td>
							...
							<tr>
							   <td>
								 <table width=\"100%\" >
									<tr>
										<td><strong>Order Note :</strong> ".ucfirst($value['product_note'])."</td>
								   </tr>
								</table>
							  </td>
							</tr>
