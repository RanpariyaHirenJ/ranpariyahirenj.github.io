					...
					{						
 						if(is_numeric($val))
						{
							...
							$sql = "DELETE FROM  manage_category WHERE category_id = $val";	
  							$db_object->execute_query($sql);
							redirect("manage_category.php?error=Category has been deleted successfully.");
							die();
						}				
					}		
        ...
        <h2 style="background:#a2a2a2"> Add / Modify Category</h2>
		  ...
		  <div class="fldCntr" align="center" style="width:600px; margin-top:0px;">
              ...
              <tr>
                <td align="left">&nbsp;</td>
                <td align="left">
                    <input type="submit" name="action" value="Save" onClick="return check_category_selected()" class="action-button">
                </td>
              </tr>
            </table>
              </div>
                ...
                <div class="frm">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                     ...
                     <!-- <input type="submit" name="action" id="action" value="Filter" style="width:100px;" class="action-button">-->
      	 ...
      	 <div class="tblCntr" style="padding-top:0; background:none;">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="20%"  style="vertical-align:middle"><?php echo ucwords($value["category_name"]); ?></td>
                <td width="35%"  style="vertical-align:middle"><?php echo ucwords($item_name) ?></td>
			  ...
			  <tr>
			  	<td colspan="6" align="center">
                    ...
                    <!--<input name="action2" type="button" value="Add Category" onClick="pop_up_box()" class="action-button">-->
                    <input name="action2" type="button" value="Add Category" onClick="pop_up_box()" > &nbsp;
                	<!--<input type="submit" name="action" id="Delete" value="Delete" class="action-button">-->
