	...
	if(isset($_REQUEST['action']))
	{
		...
		switch($_REQUEST['action'])
		{
			case "Save":
					...
					$sqlhelper->adddata("client_name,client_contact,clent_email,delivery_date,order_date,order_note",  "'$user_name',$client_contact,'$clent_email','$delivery_date','$order_date','$order_note'");
