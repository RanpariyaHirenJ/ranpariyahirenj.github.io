			...
			foreach($_POST as $key => $val)
				{
					if(is_numeric($val))
					{
						...
						redirect("manage-items.php?error=Data has been deleted successfully.");
						die();
					}				
				}
		break;
              ...
              <div class="tblCntr" style="padding-top:0; background:none;text-transform:capitalize;">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  $n = 1;			
 				  ...
 				  ?>
                  <tr>
                  	<td align="center" style="vertical-align:middle"><?php  echo ((($start * 25) - 25) + $n); $n++; ?></td>
                  	<td width="12%" align="center" style="vertical-align:middle">
                    <?php 
						if($rows['item_photo'] != "")
						{
							if(file_exists("../item-photos/".get_thumbnail($rows["item_photo"])))
							{
				  ...
				  ?>
                   <tr>
                    <td colspan="7" align="center" style="vertical-align:middle">
                    	<!--<input name="action" type="button" value="Add Item" onClick="pop_up_box()" class="action-button">-->
