      ...
      <div class="container">
        <div class="main-container">
          ...
          <div class="list-cnt">
            ...
            <h1 style="color:#fff;">Your Inquiry Cart</h1>
			...
			?>
              <li>
                ...
                <div class="product-description-inquiry-list">
                  <a href="inquiry-list.php?action=delete&item=<?php echo $key ?>" style="position:absolute;display:block;right:0;top:0;">		
