			...
			case "Delete":
					...
					{						
 						if(is_numeric($val))
						{
							...
							//$sql = "DELETE FROM  craft_mapping WHERE item_id = $val";	
 							$db_object->execute_query($sql);
						}				
					}			break;
      ...
      <div class="formCntr">
        <h2 style="background:#a2a2a2"> Add / Modify Category</h2>
		  ...
		  <div class="fldCntr" align="center" style="width:600px; margin-top:0px;">
              ...
              <tr>
                <td width="217" align="left">Select Item</td>
                <td width="469" align="left">
		...
		//$sql  = "SELECT * FROM  manage_category $whereclause  ORDER BY category_id DESC";
			...
			$sql  = "SELECT * FROM  manage_category mc
					...
					INNER JOIN  craft_items_master cim ON cim.item_id = cm.item_id
  					 $whereclause  ORDER BY cm.category_id DESC";
              ...
              <tr>
                ...
                <td width="27%" align="center" style="vertical-align:middle"><?php echo $value["category_name"] ?></td>
                <td width="28%" align="center" style="vertical-align:middle"><?php echo $item_name; ?></td>
