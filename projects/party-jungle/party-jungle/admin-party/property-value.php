                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <?php 
                  	...
                  	<td align="center" style="vertical-align:middle">
					<a style="padding:8px 12px; background-color:#CCC;border-radius:5px;"  href="property-value.php?action=Toggle&property_value_id=<?php echo $rows['property_value_id'] ?>&display_flag=<?php echo $rows["property_value_status"] ?>" id="togglebutton"  style="color:<?php if($rows["property_value_status"] == 0){echo "#2C9D28"; } else { echo "#FC5F7A"; }?>">
