	...
	switch($_REQUEST["action"])
	{
		...
		if(!isset($_REQUEST["item_id"]))
			...
			else
			{
				...
				$sql = "DELETE FROM  craft_mapping WHERE item_id =".$_REQUEST["item_id"];
				$db_object->execute_query($sql);
					...
					foreach($_POST as $key => $val)
					{
						...
						if($first == "c" && $second == "a" && $third == "t")
						{
							...
							$sql = "INSERT INTO craft_mapping (item_id, category_id) VALUES($item_id,$val)";
								//die($sql);
					...
					{
						$url_name = $url_name[0]."&error=Album has been updated successfully.";
					}
					else
					{
						$url_name = $url_name[0]."?error=Album has been updated successfully.";
	...
	<form action="manage-items.php<?php echo $item_id ?>" method="post" enctype="multipart/form-data"  onSubmit="return form_validate_jquery('.fldCntr')">
		 <div class="fldCntr" align="center" style="width:800px; margin-top:20px;">
		  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="dvF1">
				...
				?>
                <tr>
                <td width="217" align="right" style="vertical-align:middle">Items Name&nbsp;:&nbsp;</td>
                ...
                <tr>
              	<td>&nbsp;</td>
              	<td>Multiple Item can be added seperated by a " | " <br>
				...
				?>
                <tr>
                <td width="217" align="right" style="vertical-align:middle">Item Name&nbsp;:&nbsp;</td>
                <td width="469" align="left">
                <input name="item_name" required type="text" style="width:250px" title="Item Name" value="<?php echo ucwords($item_name); ?>"> 
                </td>
                </tr>
                <tr>
                <td width="217" align="right" style="vertical-align:middle">Item Thumbnail&nbsp;:&nbsp;</td>
                <td width="469" align="left">
                <input name="itemphoto" type="file">
                </td>
                </tr>
                <tr>
                <td width="217" align="right" style="vertical-align:middle">Item Description11111111111&nbsp;:&nbsp;</td>
                <td width="469" align="left">
                ...
                <tr>
                <td width="217" align="left">Select Category</td>
                <td width="469" align="left">
               ...
               <div style="height:110px; width:248px; border:1px solid #666; border-radius:5px; overflow-y:scroll" id="cat_selected_list">
				...
				$a = 1;
				$checked = "";
				$sql_cat = "SELECT * FROM manage_category";
				$result_cat = $db_object->execute_query($sql_cat);
				while($rows = mysqli_fetch_array($result_cat))
				{
					if(isset($id))
					{
						$check_sql = "SELECT * FROM  craft_mapping WHERE item_id = $id AND category_id=".$rows['category_id'];
                    ...
                    <input type="checkbox" <?php echo $checked; ?> name="cat_id<?php echo $a ?>" value="<?php echo $rows['category_id'] ?>" > &nbsp;<?php echo $rows['category_name'] ?>
					</div>
					<?php
					$a++;
				}
...
<div class="wraper">
  <h1 class="pageName">Manage Item</h1>
               ...
               <h2>Filter Data</h2>
                ...
                <div class="frm">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="52%" align="center">Item Name : 
