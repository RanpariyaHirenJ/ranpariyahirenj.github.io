...
var wrapper = $('.l-main');
var footer = $('.l-footer');
var footer_inner = $('.l-footer__inner');
var helper = {
    breakpoint: {
    ...
    set_padding: function set_padding(callback, elem) {
        var self = this,
            ...
            padding_left_l_up = $('.padding--left'),
            padding_right_l_up = $('.padding--right');
        padding_left_l_up.each(function () {
            $(this).css('padding-left', elem_offset_left + 'px');
        });
        padding_right_l_up.each(function () {
            $(this).css('padding-right', elem_offset_left + 'px');
        });
        callback();
    },
    ...
    sticky_footer_animation: function sticky_footer_animation() {
        var self = this,
            ...
            footer_top = $('.l-main').outerHeight(true),
    ...
    home_padding_top: function home_padding_top() {
        var self = this;
        if (!bowser.msie) $('.site .home').css('padding-top', self.calc_padding_top() + 'px');
    },
...
var ContentLoader = function ContentLoader(loadMoreItem, onLoadMoreCallback) {
    ...
    this.enable = function () {
        ...
        $$6(window).scroll(onScrollCallback);
    };
            ...
            try {
                for (var _iterator = this.parts[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    if (part.featured) {
                        ...
                        var container = $$4('<div class="grid__row"><div class="item featured"><div class="item-inner"></div></div></div>');
                    ...
                    /** STANDARD */
                            ...
                            if (typeof part.left.container === 'undefined') {
                                var container = $$4('<div class="grid__row two-cols-container"><div class="col-left"><div class="grid__row"></div></div><div class="col-right"><div class="grid__row"></div></div></div>');
                                container.appendTo(this.section.find('.desktop-container'));
                            ...
                            for (var index = 0; index < part.elems.length; index++) {
                                ...
                                var item = $$4('<div class="item"><div class="item-inner"></div></div>');
                                if (params.even) {
                                    item.addClass('even');
                                } else {
                                    item.addClass('odd');
...
var PhotosGrid = function () {
    ...
    createClass(PhotosGrid, [{
        ...
        value: function init() {
            ...
            this.section.addClass('visible');
            var hugeTitleContainer = $$7('.HugeProjectTitle');
            var hugeTitle = $$7('.HugeProjectTitle__title');
            var timer;
            if (bowser.mobile || bowser.touch) {
                ...
                this.section.on('mouseover', '.js-photos-grid-item', function () {
                    clearTimeout(timer);
                    hugeTitle.text($$7(this).data('title'));
                    hugeTitleContainer.addClass('active');
                    $$7('.js-photos-grid-item').addClass('inactive');
                    $$7(this).removeClass('inactive');
                });
                this.section.on('mouseout', '.js-photos-grid-item', function () {
                    clearTimeout(timer);
                    timer = setTimeout(function () {
                        hugeTitleContainer.removeClass('active');
                        $$7('.js-photos-grid-item').removeClass('inactive');
                    }, 300);
                });
            }
        }
...
var Accordion = {
    ...
    init: function init() {
        ...
        $accordionElementHead.on('click', function () {
            Accordion.toggle($$8(this).parent());
        });
    },
...
var drawer = {
    $component: $$9('.js-drawer'),
    $content: $$9('.js-drawer-content'),
    $closeDarwerHook: $$9('.js-close-drawer-hook'),
    ...
    init: function init() {
        ...
        $$9('[data-open-drawer]').on('click', function () {
            drawer.open($$9(this).data('open-drawer'));
        });
        this.$component.find('.c-drawer__background').click(function () {
            var id = $$9(this).parent().attr('id');
            drawer.close('#' + id);
        });
        ...
        this.$component.find('.c-drawer__background').hover(function () {
            $$9($$9(this).parent().find('.c-drawer__wrapper')[0]).addClass('peaking-out');
        }, function () {
            $$9($$9(this).parent().find('.c-drawer__wrapper')[0]).removeClass('peaking-out');
        });
    ...
    open: function open(id) {
        if (bowser.mobile) {
            setTimeout(function () {
                if (!$$9('body').hasClass('is-scrolling')) {
                    $$9(id).addClass(drawer.activeClass);
                    $$9('body').addClass('has-drawer-opened');
                } else {
                    return;
                }
            }, 150);
    ...
    close: function close(id) {
        $$9(id).removeClass(this.activeClass);
        $body.removeClass('noscroll');
        // If we close drawer, we close all other drawers inside that drawer
        var _this = this;
        $$9(id).find('.c-drawer').each(function () {
            _this.close('#' + $$9(this).attr('id'));
        });
    }
};
var $$3 = jQuery.noConflict();
var ProjectsFilters = {
    $forms: $$3('.js-projects-filters'),
    $mobileComponent: $$3('.js-projects-filters-mobile'),
    $desktopComponent: $$3('.js-projects-filters-desktop'),
    $toggleComponent: $$3('.js-projects-filters-open'),
    $toggleComponentTarget: $$3('.js-projects-filters-toggle-target'),
    $grid: $$3('.js-projects-grid'),
    $resetButton: $$3('.js-projects-filters-reset'),
    $submitButton: $$3('.js-projects-filters-submit'),
    $desktopFilterOpener: $$3('.js-projects-filters-header-desktop'),
    $desktopFilter: $$3('[data-desktop-filter]'),
    $filterLabels: $$3('.js-projects-filters-label'),
    $categoriesBackground: $$3('.js-categories-background'),
    $categoriesBackgroundUnclick: $$3('.js-categories-background-unclick'),
    $switchGridBigButton: $$3('.js-switch-grid-big'),
    $switchGridSmallButton: $$3('.js-switch-grid-small'),
    response: [],
    ...
    init: function init() {
        ...
        if ($$3('.irregular-grid').length > 0) {
            this.isSmallGrid = false;
            this.irregularGrid = new IrregularGrid($$3('.irregular-grid'));
            this.irregularGrid.init();
        } else {
            this.photosGrid = new PhotosGrid($$3('.SectionPhotosGrid'));
    ...
    _updateDOMFromState: function _updateDOMFromState() {
        ...
        this.$forms.find('input').each(function (index, item) {
            var key = $$3(item).attr('name');
            var value = $$3(item).attr('value');
            if (_this3.state[key] && _this3.state[key].indexOf(value) > -1) {
                $$3(item).attr('checked', true);
            } else {
                $$3(item).removeAttr('checked');
            }
        });
        // Update filter titles
        var totalCount = 0;
        this.$filterLabels.each(function (index, labelNode) {
            labelNode = $$3(labelNode);
    ...
    _addEventListeners: function _addEventListeners() {
        ...
        this.$desktopFilterOpener.on('click', function (e) {
            e.stopPropagation();
            if ($$3(this).hasClass('is-selected')) {
                ProjectsFilters.closeDesktopFilter();
            } else {
                ProjectsFilters.openDesktopFilter($$3(this).data('id'));
            }
        });
        ...
        this.$forms.on('change', 'input', function (ev) {
            ...
            var key = $$3(ev.target).attr('name');
            var value = $$3(ev.target).attr('value');
            var checked = $$3(ev.target).is(':checked');
            if (checked) {
    ...
    openDesktopFilter: function openDesktopFilter(filterId) {
        ...
        $$3('.js-projects-filters-header-desktop[data-id=' + filterId + ']').addClass('is-selected');
        var category = $$3('[data-desktop-filter="' + filterId + '"]');
    ...
    _fetchData: function _fetchData(loadSmallGrid) {
        ...
        this.xhr = $$3.ajax({
            ...
            var $html$$1 = $$3(ProjectsFilters.response);
            if ($$3('.irregular-grid').length > 0) {
...
module$1.exports = MarkerClusterer;
        ...
        if ($$10('.js-az-side-panel-cover').length) {
            ...
            var markers = locations.map(function (location, i) {
                ...
                newMarker.addListener('mouseover', function () {
                    ...
                    $$10('.gm-style-iw').parent().each(function (index) {
                        $$10(this).addClass('c-infowindow');
                    });
                });
...
var dragCursor = {
    init: function init(dragSpace) {
        ...
        function getCursorPosition() {
            ...
            cursorPos.y = event.pageY - $$13(window).scrollTop();
        }
        $$13('body').mousemove(function (event) {
...
var box = {
    matchBoxTextHeightInRow: function matchBoxTextHeightInRow(boxes) {
        ...
        function _matchBoxTextHeight(rows_of_boxes) {
            ...
            for (var i = 0; i < rows_of_boxes.length; i++) {
                $$14(rows_of_boxes[i]).find('.c-box__wrapper-text').each(function () {
                    var element_height = $$14(this).outerHeight();
        ...
        if (boxes_in_row == 0) {
            ...
            $$14(boxes).find('.c-box__wrapper-text').css('height', 'auto');
            return;
        } else {
            var rows = [[]];
            var i = boxes_in_row;
...
var carousel_mixed_image_wrap = $$12('.carousel--mixed .carousel__item-inner .image-wrap');
var options = {
	multi: (_multi = {
		freeScroll: true,
		cellAlign: 'left',
...
var slider = {
	...
	gallery: function gallery() {
		$$12('.carousel--gallery').flickity(options.gallery);
	},
	disable_multi_drag: function disable_multi_drag() {
		var carousel = $$12('.carousel--multi').flickity(options.multi),
		    item = $$12('.carousel--multi .carousel__item');
		if (window.matchMedia('(min-width: 740px)').matches && item.length < 4) {
			carousel.flickity('unbindDrag');
		} else {
			dragCursor.init($$12('.carousel--multi'));
	...
	multi: function multi() {
		...
		function setCarouselTextHeight() {
			$$12('.carousel--multi').each(function () {
				box.matchBoxTextHeightInRow($$12(this).find('.c-box'));
			});
		}
		if (carousel.length != 0) {
			setCarouselTextHeight();
			$$12(window).resize(setCarouselTextHeight);
		}
	},
	mixed: function mixed() {
		var carousel = $$12('.carousel--mixed').flickity(options.mixed);
		dragCursor.init($$12('.carousel--mixed'));
		...
		carousel.on('dragStart.flickity', function (event, pointer, cellElement, cellIndex) {
			$$12(this).addClass('is-drag');
		});
		carousel.on('dragEnd.flickity', function (event, pointer, cellElement, cellIndex) {
			$$12(this).removeClass('is-drag');
		});
	},
	set_mixed_height: function set_mixed_height() {
		var max_height = -1;
		carousel_mixed_image_wrap.each(function () {
			max_height = max_height > $$12(this).height() ? max_height : $$12(this).height();
		});
		carousel_mixed_image_wrap.each(function () {
			if ($$12(this).height() != max_height) {
				$$12(this).height(max_height);
			}
		});
	},
	set_margin_bottom: function set_margin_bottom() {
		carousel_mixed_image_wrap.each(function () {
			var image = $$12(this).find('.image--visible-on-desktop img');
			if (window.matchMedia('(max-width: 790px)').matches) {
				image = $$12(this).find('.image--visible-on-mobile img');
			}
			var diff = ($$12(this).height() - image.height()) / 2,
			    caption = $$12(this).next('.carousel__item-caption');
			if (caption.length > 0 && image.height() < $$12(this).height()) {
				$$12(this).css('margin-bottom', -diff + 'px');
			}
		});
	},
	reveal: function reveal() {
		$$12('.carousel--reveal').flickity(options.gallery);
	},
	// initialised after ajax call
	instafeed: function instafeed() {
		$$12('#instafeed').flickity(options.multi);
	},
	single: function single() {
		var carousel = $$12('.carousel--single').flickity(options.single),
		    is_flickity = true;
		if (is_flickity) {
			if (window.matchMedia('(min-width: 770px)').matches) {
				$$12('.carousel--single').flickity('destroy');
			} else {
				carousel.flickity();
			}
		}
...
var grid_debugger = {
	init: function init() {
		...
		//    if(e.keyCode == 71){
		//        // user has pressed "g" key
		// 		if (!debuggerEnabled) {
		// 			$body.append(node);
		// 			debuggerEnabled = true;
		// 		} else {
		// 			$body.find('.debugger').remove();
...
var VerticalScrollDetector = new function () {
  ...
  $$26(window).on("touchstart", function (ev) {
    initScroll = $$26(window).scrollTop();
  });
  $$26(window).on("touchmove", function (ev) {
    if (!isScrolling) {
      var scroll = $$26(window).scrollTop();
      if (scroll != initScroll) {
        isScrolling = true;
      }
    }
  });
  $$26(window).on("touchend", function (ev) {
    isScrolling = false;
  });
...
var videoPlayer = {
    ...
    _playFromStart: function _playFromStart(player) {
        player.bigPlayButton.on('click', function () {
            ...
            if ($$27('body').hasClass('single')) {
                ...
                $$27('.vjs-control-bar').append(vjsShareHTML);
                $$27('.vjs-share-toggle').click(function () {
                    $$27('.vjs-video-share').toggleClass("open");
                });
            }
        });
    },
    _getVideos: function _getVideos() {
        ...
        for (var i = 0; i < videos.length; i++) {
            ...
            if (video.className.indexOf('video-js') > -1) {
                ...
                // }
                //this._videoJS.share();
                if ($$27(video).parent().hasClass('video-module')) {
                    this._autoPlay();
    ...
    realInit: function realInit() {
        var _this2 = this;
        this._container = $$27('#video-player-container');
...
var videosSlider = {
  init: function init() {
    var container = $$25('.videos-container');
    var containerInner = $$25('.videos-container-inner');
    var carousel = $$25('.videos-carousel');
    ...
    setContainerSize();
    $$25(window).resize(setContainerSize);
    // Init layout
    ...
    videos.find('.button').click(function () {
      ...
      var sources = $$25(this).data('video-sources');
  ...
  read_more_toggle: function read_more_toggle() {
    ...
    target.each(function () {
      ...
      trigger.on('click', function () {
        ...
        if ($$29(this).text() == text_more) $$29(this).text(text_less);else $$29(this).text(text_more);
      });
    });
  },
...
var overlayGallery = new function () {
    ...
    this._cloneImagesToGrid = function () {
        ...
        _this2.$images.each(function (index, node) {
            ...
            $$31($img[0]).css({ paddingBottom: $$31($img[0]).data("padding") });
...
var grids = {
    $grids: $$39('.c-grid-boxes .grid__row'),
    init: function init() {
...
var form = $$38('#search-form');
var field = $$38('.search-field');
var close = $$38('[data-search-close]');
var overlay = $$38('.search-overlay');
...
var search = {
	...
	show_form: function show_form() {
		$$38('[data-search]').on('click', function () {
	...
	tabs: function tabs() {
		var tabs = $$38('.search-tabs'),
		    tab = $$38('.search-tab');
		tab.each(function (i) {
			tabs.append('<li data-tab="' + $$38(this).attr('id') + '" ' + (i == 0 ? 'class="current"' : '') + '><span>' + $$38(this).data('label') + '</span></li>');
			i + 1;
		});
		$$38('.tabs li').on('click', function () {
			var tab_id = $$38(this).attr('data-tab'),
			    tab = $$38("#" + tab_id);
			$$38('.tabs li').removeClass('current');
			$$38('.tab__content').removeClass('current');
