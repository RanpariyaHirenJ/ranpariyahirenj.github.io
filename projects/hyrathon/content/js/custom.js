$(document).ready(function() {
    ...
    $("#menu3 .master-menu").click(function() {
        $("#link-bottom3").slideToggle();
    });
    $("#menu4 .master-menu").click(function() {
        $("#link-bottom4").slideToggle();
    });
    $("#menu5 .master-menu").click(function() {
        $("#link-bottom5").slideToggle();
    });
