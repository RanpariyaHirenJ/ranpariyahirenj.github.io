...
<footer> 
  ...
  <div class="lb-footer-copyright">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
            <p>Copyright&copy; <?php echo esc_html(date_i18n(__('Y','lawblog'))).' '; bloginfo( 'name' ); ?> | <?php printf( esc_html__( 'Designed by %1$s', 'lawblog' ),  '<a href="'.esc_url('http://lawsiteblog.com/').'">lawblog</a>' ); ?>. <?php esc_html_e('Powered by ', 'lawblog'); ?> <a href="<?php echo esc_url('https://wordpress.org/'); ?>"><?php esc_html_e('WordPress', 'lawblog'); ?></a></p>
          </div>
