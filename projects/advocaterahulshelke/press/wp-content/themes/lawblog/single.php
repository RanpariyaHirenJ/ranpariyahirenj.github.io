            ...
            <div class="col-lg-12">
              <div class="lb-blog-post-box"> 
                ...
                <article class="small">
                  ...
                  <?php wp_link_pages( array( 'before' => '<div class="link single-post-link">' . __( 'Pages:', 'lawblog' ), 'after' => '</div>' ) ); ?>
                </article>
              </div>
            </div>
  		      <?php } ?>
            <div class="col-lg-12">
              <div class="media lb-info-author-block"> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>" class="lb-author-pic"> <?php echo get_avatar( get_the_author_meta( 'ID') , 150); ?> </a>
                <div class="media-body">
                  <h4 class="media-heading"><?php esc_html_e('About:', 'lawblog'); ?> <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php the_author(); ?></a></h4>
